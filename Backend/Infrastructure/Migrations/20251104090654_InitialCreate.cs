        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountInfo = table.Column<string>(type: "text", nullable: true),
                    OfferValidUntil = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CookingFactor = table.Column<decimal>(type: "numeric", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodId = table.Column<int>(type: "integer", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    EuroFIRCode = table.Column<string>(type: "text", nullable: true),
                    Abbreviation = table.Column<string>(type: "text", nullable: true),
                    Value = table.Column<decimal>(type: "numeric", nullable: true),
                    Unit = table.Column<string>(type: "text", nullable: true),
                    WeightGram = table.Column<decimal>(type: "numeric", nullable: true),
                    MatrixUnit = table.Column<string>(type: "text", nullable: true),
                    MatrixUnitCode = table.Column<string>(type: "text", nullable: true),
                    Calculation = table.Column<string>(type: "text", nullable: true),
                    ValueType = table.Column<string>(type: "text", nullable: true),
                    ValueTypeCode = table.Column<string>(type: "text", nullable: true),
                    Origin = table.Column<string>(type: "text", nullable: true),
                    OriginCode = table.Column<string>(type: "text", nullable: true),
                    Publication = table.Column<string>(type: "text", nullable: true),
                    MethodType = table.Column<string>(type: "text", nullable: true),
                    MethodTypeCode = table.Column<string>(type: "text", nullable: true),
                    MethodIndicator = table.Column<string>(type: "text", nullable: true),
                    MethodIndicatorCode = table.Column<string>(type: "text", nullable: true),
                    ReferenceType = table.Column<string>(type: "text", nullable: true),
                    ReferenceTypeCode = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NutritionValues_Products_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Products_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
