...
namespace Application.Product.Interfaces
{
    public interface IProductService
    {
        ...
        Task<InfiniteScrollResponse<ProductResponseDto>> FilterProducts(string? name, string? brand, int? categoryId, int? subCategoryId, int? subSubCategoryId, decimal? price, int page, int pageSize, CancellationToken ct);
    }
}
